...
Shape* shape_create_circle(Vec3 center, float radius, Color color, u32 segments, float start_angle, float end_angle)
{
    ...
    Vec3 *points = (Vec3*)malloc(sizeof(Vec3) * segments);
    float step = 0;
    ...
    ShapeVertexData* vertices = (ShapeVertexData*)malloc(sizeof(ShapeVertexData) * segments);
    u32 *indices = (u32*)malloc(sizeof(u32) * segments * 2);
...
{
    ShapeVertexData* vertices = (ShapeVertexData*)malloc(sizeof(ShapeVertexData) * segs_x * 2 * segs_y * 2);
    u32 *indices = (u32*)malloc(sizeof(u32) * segs_x * 2 * segs_y * 2);
